...
VALUES (2, 1, 29.99, NULL, 3, 2),
(1, 0, 4.99, '2024-02-01', 2, 2),
(3, 1, 17.99, NULL, 3, 2),
(1, 1, 24.99, NULL, 4, 2),
(2, 0, 14.99, '2024-02-03', 5, 2),
(1, 1, 9.99, NULL, 6, 2),
(4, 1, 27.99, NULL, 8, 3),
(1, 0, 3.99, '2024-02-05', 3, 3),
(2, 1, 22.99, NULL, 8, 3),
(3, 1, 19.99, NULL, 2, 4),
(2, 0, 6.99, '2024-02-07', 1, 4),
(1, 1, 11.99, NULL, 1, 4),
(1, 1, 29.99, NULL, 2, 5),
(3, 0, 12.99, '2024-02-09', 2, 5),
(2, 1, 23.99, NULL, 3, 5),
(2, 1, 15.99, NULL, 5, 6),
(1, 0, 8.99, '2024-02-11', 5, 6),
(3, 1, 18.99, NULL, 7, 6);

INSERT INTO bills (cuil, location, total, id_order)
VALUES 
    (234567890, 'Ciudad B', 218.25, 1), 
    (34567890123, 'Ciudad C', 80.45, 2),
    (45678901234, 'Ciudad D', 320.00, 3), 
    (56789012345, 'Ciudad E', 168.15, 4),
    (12345678901, 'Ciudad A', 135.50, 5),
    (23456789012, 'Ciudad B', 218.25, 6),
    (34567890123, 'Ciudad C', 80.45, 6),
    (45678901234, 'Ciudad D', 320.00, 7),
    (56789012345, 'Ciudad E', 168.15, 8),
    (56789012345, 'Ciudad Z', 168.15, 10);
